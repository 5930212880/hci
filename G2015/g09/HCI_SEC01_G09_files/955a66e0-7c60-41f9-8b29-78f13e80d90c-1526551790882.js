jQuery("#simulation")
.on("click", ".s-955a66e0-7c60-41f9-8b29-78f13e80d90c .click", function(event, data) {
...
.on("pageload", ".s-955a66e0-7c60-41f9-8b29-78f13e80d90c .pageload", function(event, data) {
var jEvent, jFirer, cases;
if(data === undefined) { data = event; }
jEvent = jimEvent(event);
jFirer = jEvent.getEventFirer();
