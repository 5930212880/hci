jQuery("#simulation")
  .on("click", ".s-2f196579-398b-4690-abe0-9d1c4d4940a3 .click", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-2f196579-398b-4690-abe0-9d1c4d4940a3 #s-Image_28 > svg": {
                      "attributes": {
                        "overlay": "#80B8F1"
                      }
                    }
  ...
  .on("pageload", ".s-2f196579-398b-4690-abe0-9d1c4d4940a3 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
