		...
		<div class='main-content' >
			...
			<div class='sections' >
				...
				<!--=====================================================
					letcture Section
				=====================================================-->
				<section id='lecture' class='section about-section border-d' >
					...
					<div class='section-block about-block' >
						<div class='container-fluid' >
							...
							<div class='section-header' >
								<h2>
									<strong class='color' >Human-Computer Interaction<p>slide lecture</p></strong>
								</h2>
							</div>
				...
				<!--=====================================================
					lab Section
				=====================================================-->
				<section id='lab' class='section about-section border-d' >
					...
					<div class='section-block about-block' >
						<div class='container-fluid' >
							...
							<div class='section-header' >
								<h2>
									<strong class='color' >Human-Computer Interaction<p>slide lab</p></strong>
								</h2>
							</div>
							...
							<div class='row' >
								...
								<div class='col-md-4' >
									...
									<ul class='info-list' style='margin-top:-50px;' >
										...
										<li>
										<a href='#portfolio1' data-section='portfolio1' target="_blank">Digital Portfolio - 2014</a>
										</li>

										<li>
										<a href='#portfolio2'  data-section='portfolio2' target="_blank">Digital Portfolio - 2017</a>
										</li>
